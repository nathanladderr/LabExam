        ...
        <div class="tittle-header">
          ...
          <div class="container overflow">
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a href="reports_residency">Certificate Of Residency / <span class='count-report'><?php echo $residency_count; ?></span></a></li>
              <?php 
                ...
                while ($row = mysqli_fetch_array($select)) {
                  ...
                  if ($role != "Captain") {
                    ...
                    <div class="text-right" style='margin-right: 80px; margin-top:5px;'>
              ...
              <div id="residency" class="tab-pane fade in active" style="margin-right: 80px;">
                <form method='POST' action='code.php'>
                  <div class="resident">
                    <div class="table">
                      <table class="table table-stripes">
                        <h1 class='files-text'>Barangay Residency Transaction Records:</h1>
                        <thead>
                          <tr>
                              <th>Fullname</th>
                              <th>Transaction</th>
                            ...
                            <?php 
                              include 'database/db_connection.php';
                               $recordperpage = 5;
                                ...
                                $select = mysqli_query($dbcon,"SELECT * FROM tbltransaction WHERE Type ='Residency'");
                                ...
                                $view_indigency=mysqli_query($dbcon,"SELECT * FROM `tbltransaction` WHERE Type ='Residency' LIMIT $startfrom, $recordperpage ");//select query for viewing users.  
                                ...
                                <form method="POST" action="code.php">
                                  <tr>
                                    ...
                                    <td><input class="btn btn-danger" type="submit" name="delete-residency" value="Delete"></td>
                                  </tr>
                                  <?php      
                                  } elseif($row['status'] == ''){?>
                                    <tr style='background-color: lightblue;'>
                                        ...
                                        <td><input class="btn btn-danger" type="submit" name="delete-residency" value="Delete" onclick="return confirm('Are you sure you want to delete this Records!!')"></td>
                                    </tr>
