                    ...
                    <form role="form" method="post" action="admin_login.php">  
                        <fieldset>  
                            <div class="form-group"  >  
                                <input class="form-control" placeholder="Name" name="admin_name" type="" autofocus>  
                            </div>  
                            <div class="form-group">  
...
{  
    ...
    $admin_query="select * from tbladmin where admin_name='$admin_name' AND admin_pass='$admin_pass'";  
