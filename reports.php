      ...
      <div id="residents">
        <div class="tittle-header">
            ...
            <div class="text-right adminauth">
              <h2 class='text-admin'>Welcome: <a style='font-family: Lucida Fax;color: black;text-decoration: none;' href=""><?php echo $_SESSION['admin_name']; ?></span></h2>
          </div>
        </div>
          <div class="container overflow">
            <ul class="nav nav-tabs">
                ...
                ?>
              <li class="active"><a href="">Business Permit / <span class='count-report'><?php echo $business_count; ?></span></a></li>
              <li><a href="reports_clearance">Barangay Clearance / <span class='count-report'><?php echo $clearance_count; ?></span></a></li>
              ...
              <?php 
                ...
                while ($row = mysqli_fetch_array($select)) {
                  ...
                  if ($role != "Captain") {
                    ...
                    <div class="text-right" style='margin-right: 60px; margin-top:5px;'>
                      <form method='POST' action='code.php'>
                        <input class='btn btn-primary' type='submit' name='clear_notification' value='Clear Notification'>
                      </form>
                    </div>
                  <?php
                  }
            ...
            <div class="tab-content" style="margin-right: 60px">
              <div id="permit" class="tab-pane fade in active">
                  <form method='POST' action='code.php'>
                    <div class="resident">
                      <div class="table">
                        <table class="table table-stripes">
                          <h1 class='files-text'>Barangay Permit Transaction Records:</h1>
                          <thead>
                            <tr>
                                <th>Fullname</th>
                                <th>Transaction</th>
                              ...
                              <?php 
                                include 'database/db_connection.php';
                                 $recordperpage = 5;
                                  ...
                                  $select = mysqli_query($dbcon,"SELECT * FROM tbltransaction WHERE Type ='Business'");
                                  ...
                                  $view_indigency=mysqli_query($dbcon,"SELECT * FROM `tbltransaction` WHERE Type ='Business' LIMIT $startfrom, $recordperpage ");//select query for viewing users.  
                                  ...
                                  <form method="POST" action="code.php">
                                    <tr>
                                      ...
                                      <td><input class="btn btn-danger" type="submit" name="delete-permit" value="Delete">||<input class="btn btn-primary" type="submit" name="delete-permit" value="Print"></td>
                                    ...
                                    <tr style='background-color: lightblue;'>
                                        ...
                                        <td><input class="btn btn-danger" type="submit" name="delete-permit" value="Delete" onclick="return confirm('Are you sure you want to delete this Records!!')">||<input class="btn btn-primary" type="submit" name="delete-permit" value="Print" onclick="return confirm('Are you sure you want to Print this Records!!')"></td>
