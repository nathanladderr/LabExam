...
<div class="col-md-10 right-section">
  ...
  <div class="tittle-header">
        <h3 style="text-align: center;font-size: 30px">Clearance Page</h3>
        ...
        <table id="myTable" class="table table-stripes">
          ...
          <tbody> 
           ...
           <tr>
             ...
             <td><a class='btn btn-primary' data-toggle="modal" data-target="#myModal" residentid="<?php echo $row['id']; ?>" >Issue Barangay Clearance</a></td>
          </tr>
                ...
                <form method='POST' action='code.php'>
                  ...
                  ?>
                   ...
                   <div class="buttons text-right" style='margin-top:20px;'>
                      <input class='btn btn-primary' type='submit' name='submit-clearance' value='Proceed'>
